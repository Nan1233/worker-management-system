...
export type DeductionKey = Extract<keyof DeductionState, string>;

export const processMap: Record<string, { id: number; title: string; machineLabel: string }> = Object.fromEntries(
    Object.entries(PROCESS_FORM_SCHEMAS).map(([slug, schema]) => [slug, {
        id: schema.processId,
        title: schema.title,
...
export const getWorkerMinWorkDate = (): string => shiftLocalDate(getCurrentLocalDate(), -14);
...
export const decimalHoursToText = (value: string): string => {
    ...
    const parsedHours = hourMinuteMatch ? Number(hourMinuteMatch[1]) + Math.min(59, Number(hourMinuteMatch[2])) / 60 : Number(normalized || 0);
...
export const initialForm: FormState = {
    workDate: getCurrentLocalDate(), shift: "A", workerCode: "", workerName: "", trainingPercent: "", machineNo: "",
    totalTime: "", actualTime: "", actualHours: "", actualMinutes: "", deductionTime: "", productName: "", standardOutput: "", actualOutput: "",
    ttOk: "", ttNg: "", kqdDapLai: "", kqdTuot: "", voDoLong: "", xuocDoLong: "", congGay: "", xoay: "", khongDut: "", baviaHut: "", ppcm: "", loiCaoSu: "", ngKichThuoc: "", catLem: "", note: ""
};

export const initialDeduction: DeductionState = {
    thieuSanLuong: "", batMay: "", chuyenMa: "", chinhMay: "", choChinhMay: "", matDien: "", matKhi: "", choHang: "", baoDuongMay: "", nghiGiaiLao: "", giaoCa: "", dungMayHoTro: "", giatCs: "", fiveS: "", hocViec: ""
};

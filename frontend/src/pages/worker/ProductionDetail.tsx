    ...
    <main className="worker-form-page readonly-report-page">
      <div className="readonly-report-shell">
        <div className="readonly-report-toolbar">
          ...
          <button
            type="button"
            className="worker-floating-save readonly-edit-button"
            disabled={!canEdit}
      ...
      <style>{`
        ...
        .readonly-report-toolbar-copy strong{font-size:15px}
        .readonly-report-toolbar-copy span{font-size:11px;color:#64748b}
        .readonly-edit-button{min-height:38px;padding:0 16px;white-space:nowrap}
        .readonly-report-form{position:relative}
        /* Reuse the exact worker input form. Only the edit-only controls are hidden. */
        ...
        /* Make every field visually identical to the real input form but completely read-only. */
        .readonly-report-form .worker-form-container,
        .readonly-report-form .worker-form-container *{pointer-events:none!important}
        .readonly-report-form .worker-sticky-context,
        .readonly-report-form .worker-sticky-context *{pointer-events:none!important}
        .readonly-report-form input,
        .readonly-report-form select,
        .readonly-report-form textarea,
        .readonly-report-form button{cursor:default!important}
        @media(max-width:680px){
          .readonly-report-toolbar{padding:8px 9px;gap:8px}
          .readonly-report-toolbar-copy strong{font-size:13px}
          .readonly-report-toolbar-copy span{font-size:10px}
          .readonly-edit-button{padding:0 11px;font-size:11px}
        }
      `}</style>
    </main>
  );

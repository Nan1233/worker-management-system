...
export default function ApprovedReports() {
    ...
    useEffect(() => { setPage(1); setEditing(false); setDrafts({}); setSelected(new Set()); }, [date, range, process, shift, search]);
    ...
    const save = async () => {
        ...
        try {
            ...
            invalidateManagerReportCaches(); setDrafts({}); setEditing(false); showToast("Đã lưu toàn bộ thay đổi", "success");
    ...
    const add = () => {
        ...
        setReports(cur => [blank, ...cur]); setDrafts(cur => ({ ...cur, [tempId]: blank })); setSelected(new Set([tempId])); setEditing(true);
    };
    ...
    const saveNew = async () => {
        ...
        try {
            ...
            invalidateManagerReportCaches(); await load(); setEditing(false); setDrafts({}); showToast("Đã thêm báo cáo", "success");

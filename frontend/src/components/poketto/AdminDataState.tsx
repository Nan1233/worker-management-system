...
export function AdminDataState({loading,error,empty,children,emptyText="Chưa có dữ liệu."}:{loading?:boolean;error?:string|null;empty?:boolean;children:ReactNode;emptyText?:string}){

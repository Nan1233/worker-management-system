...
const css = fs.readFileSync(path.join(root, "frontend/src/styles/worker-final-ui.css"), "utf8");
const hardening = fs.readFileSync(path.join(root, "frontend/src/styles/interaction-hardening.css"), "utf8");
const timeUi = fs.readFileSync(path.join(root, "frontend/src/pages/worker/components/ProcessTimeDeductionSection.tsx"), "utf8");
const timeLogic = fs.readFileSync(path.join(root, "frontend/src/pages/worker/processDeductionLogic.ts"), "utf8");
const validation = fs.readFileSync(path.join(root, "frontend/src/pages/worker/ProcessPage.tsx"), "utf8");
